...
public class CFT {
        ...
        public String getResults(String agegroup) {
            ...
            resultsString += "\nMUF: " + MUFMin + ":" + String.format("%02d", MUFSec) + "   Score: " + MUFScore;
        ...
        private void makeScores() {
            ...
            if (Gender) {//male tables
                ...
                Log.i("MTCMin: ", Integer.toString(MTCMin));
                Log.i("MTCSec: ", Integer.toString(MTCSec));
                Log.i("MUFMin: ", Integer.toString(MUFMin));
                Log.i("MUFSec: ", Integer.toString(MUFSec));
